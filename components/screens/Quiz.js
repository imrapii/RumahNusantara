            ...
            <View style={{ backgroundColor: '#273032', flex: 1 }}>
                ...
                <View style={{ backgroundColor: "#162023", width: "100%", height: 711, marginTop: 60, borderRadius: 40 }}>
                    <ScrollView horizontal={false}>
                        <Text style={{color: "white", fontSize: 14, marginTop:32, marginLeft:55, marginRight:55}}>
                            Uji pemahaman Anda tentang konsep ini dengan menjawab beberapa pertanyaan singkat.
                        </Text>
                        <Image source={require('../assets/F25.png')} style={{borderRadius:16, width:326, height:154, alignSelf:"center", marginTop:15}}/>
                        ...
                        <Text style={{color: "white", fontSize: 14, marginTop:4, marginLeft:55, marginRight:55, marginBottom:90, fontWeight:"400"}}>
